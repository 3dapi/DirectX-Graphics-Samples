...
void D3D12ExecuteIndirect::LoadPipeline()
{
    ...
    // Create descriptor heaps.
    {
        ...
        cbvSrvUavHeapDesc.NumDescriptors = CbvSrvUavDescriptorCountPerFrame * m_RenderTargetCount;
        cbvSrvUavHeapDesc.Type = D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV;
        cbvSrvUavHeapDesc.Flags = D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE;
        ThrowIfFailed(m_d3dDevice->CreateDescriptorHeap(&cbvSrvUavHeapDesc, IID_PPV_ARGS(&m_cbvSrvUavHeap)));
...
void D3D12ExecuteIndirect::LoadAssets()
{
    ...
    ThrowIfFailed(m_d3dDevice->CreateCommandList(0, D3D12_COMMAND_LIST_TYPE_COMPUTE, m_computeCommandAllocators[m_frameIndex].Get(), m_computeState.Get(), IID_PPV_ARGS(&m_computeCommandList)));
    ...
    // Create the vertex buffer.
    {
        ...
        UpdateSubresources<1>(m_d3dCommandList.Get(), m_vertexBuffer.Get(), vertexBufferUpload.Get(), 0, 0, 1, &vertexData);
    ...
    // Create the constant buffers.
    {
        ...
        for (UINT frame = 0; frame < m_RenderTargetCount; frame++)
        {
            srvDesc.Buffer.FirstElement = frame * TriangleCount;
            m_d3dDevice->CreateShaderResourceView(m_constantBuffer.Get(), &srvDesc, cbvSrvHandle);
    ...
    // Create the command signature used for indirect drawing.
    {
        ...
        ThrowIfFailed(m_d3dDevice->CreateCommandSignature(&commandSignatureDesc, m_d3dRootSignature.Get(), IID_PPV_ARGS(&m_commandSignature)));
    ...
    // Create the command buffers and UAVs to store the results of the compute work.
    {
        ...
        const UINT commandBufferSize = CommandSizePerFrame * m_RenderTargetCount;
        ...
        UpdateSubresources<1>(m_d3dCommandList.Get(), m_commandBuffer.Get(), commandBufferUpload.Get(), 0, 0, 1, &commandData);
        m_d3dCommandList->ResourceBarrier(1, &CD3DX12_RESOURCE_BARRIER::Transition(m_commandBuffer.Get(), D3D12_RESOURCE_STATE_COPY_DEST, D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE));
        ...
        {
            srvDesc.Buffer.FirstElement = frame * TriangleCount;
            m_d3dDevice->CreateShaderResourceView(m_commandBuffer.Get(), &srvDesc, commandsHandle);
    ...
    // Create synchronization objects and wait until assets have been uploaded to the GPU.
    {
        ...
        ThrowIfFailed(m_d3dDevice->CreateFence(m_fenceValues[m_frameIndex], D3D12_FENCE_FLAG_NONE, IID_PPV_ARGS(&m_computeFence)));
...
void D3D12ExecuteIndirect::OnRender()
{
    try
    {
        ...
        if (m_enableCulling)
        {
            PIXBeginEvent(m_d3dCommandQueue.Get(), 0, L"Cull invisible triangles");
            ...
            m_d3dCommandQueue->Wait(m_computeFence.Get(), m_fenceValues[m_frameIndex]);
        }
...
void D3D12ExecuteIndirect::PopulateCommandLists()
{
    ...
    // Record the rendering commands.
    {
        ...
        m_d3dCommandList->RSSetScissorRects(1, m_enableCulling ? &m_cullingScissorRect : &m_scissorRect);
        ...
        D3D12_RESOURCE_BARRIER barriers[2] = {
            ...
            CD3DX12_RESOURCE_BARRIER::Transition(
                m_d3dRenderTarget[m_frameIndex].Get(),
        ...
        m_d3dCommandList->ClearDepthStencilView(dsvHandle, D3D12_CLEAR_FLAG_DEPTH, 1.0f, 0, 0, nullptr);
        ...
        if (m_enableCulling)
        {
            PIXBeginEvent(m_d3dCommandList.Get(), 0, L"Draw visible triangles");

            // Draw the triangles that have not been culled.
            m_d3dCommandList->ExecuteIndirect(
        ...
        {
            PIXBeginEvent(m_d3dCommandList.Get(), 0, L"Draw all triangles");
