...
void D3D12HelloTexture::LoadAssets()
{
    ...
    // Create the texture.
    {
        ...
        UpdateSubresources(m_d3dCommandList.Get(), m_texture.Get(), textureUploadHeap.Get(), 0, 0, 1, &textureData);
...
void D3D12HelloTexture::PopulateCommandList()
{
    ...
    m_d3dCommandList->SetGraphicsRootDescriptorTable(0, m_srvHeap->GetGPUDescriptorHandleForHeapStart());
