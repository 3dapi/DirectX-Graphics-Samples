...
void D3D12DepthBoundsTest::LoadAssets()
{
    ...
    // Create the pipeline state, which includes compiling and loading shaders.
    {
        ...
        ThrowIfFailed(m_d3dDevice->CreatePipelineState(&renderWithDBTPSOStreamDesc, IID_PPV_ARGS(&m_d3dPipelineState)));
...
void D3D12DepthBoundsTest::PopulateCommandList()
{
    ...
    // re-recording.
    ThrowIfFailed(m_d3dCommandList->Reset(m_d3dCommandAllocator.Get(), m_depthOnlyPipelineState.Get()));
    ...
    {
        m_d3dCommandList->OMSetDepthBounds(0.0f + f, 1.0f - f);
    }
