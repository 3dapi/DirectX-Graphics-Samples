...
void D3D12Bundles::LoadAssets()
{
    ...
    ThrowIfFailed(m_d3dDevice->CreateCommandList(0, D3D12_COMMAND_LIST_TYPE_DIRECT, m_d3dCommandAllocator.Get(), nullptr, IID_PPV_ARGS(&m_commandList)));
...
void D3D12Bundles::PopulateCommandList(FrameResource* pFrameResource)
{
    ...
    // re-recording.
    ThrowIfFailed(m_commandList->Reset(m_pCurrentFrameResource->m_d3dCommandAllocator.Get(), m_pipelineState1.Get()));
