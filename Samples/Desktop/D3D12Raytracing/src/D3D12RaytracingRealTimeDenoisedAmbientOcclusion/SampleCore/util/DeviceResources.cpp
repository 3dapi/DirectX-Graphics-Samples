...
void DeviceResources::Present(D3D12_RESOURCE_STATES beforeState, UINT syncInterval)
{
    ...
    if (m_options & c_AllowTearing)
    {
        ...
        hr = m_d3dSwapChain->Present(syncInterval != UINT_MAX ? syncInterval : 0, DXGI_PRESENT_ALLOW_TEARING);
    }
    else
    {
        ...
        hr = m_d3dSwapChain->Present(syncInterval != UINT_MAX ? syncInterval : 1, 0);
    }
