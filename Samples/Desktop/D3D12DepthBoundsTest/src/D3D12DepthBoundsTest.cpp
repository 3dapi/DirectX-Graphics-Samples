...
void D3D12DepthBoundsTest::LoadAssets()
{
    ...
    // Create the pipeline state, which includes compiling and loading shaders.
    {
        ...
        renderWithDBTPSOStream.RootSignature = m_d3dRootSignature.Get();
        ...
        DepthBoundsTestSupported = SUCCEEDED(m_d3dDevice->CheckFeatureSupport(D3D12_FEATURE_D3D12_OPTIONS2, &Options, sizeof(D3D12_FEATURE_DATA_D3D12_OPTIONS2))) &&
        ...
        ThrowIfFailed(m_d3dDevice->CreatePipelineState(&renderWithDBTPSOStreamDesc, IID_PPV_ARGS(&m_pipelineState)));
        ...
        depthOnlyPSOStream.RootSignature = m_d3dRootSignature.Get();
        ...
        ThrowIfFailed(m_d3dDevice->CreatePipelineState(&depthOnlyPSOStreamDesc, IID_PPV_ARGS(&m_depthOnlyPipelineState)));
    }
...
void D3D12DepthBoundsTest::PopulateCommandList()
{
    ...
    // re-recording.
    ThrowIfFailed(m_commandList->Reset(m_d3dCommandAllocator.Get(), m_depthOnlyPipelineState.Get()));
