...
void D3D12On7::LoadPipeline()
{
    ...
    if (SUCCEEDED(m_d3dDevice.As(&deviceDownlevel)))
    {
        // D3D12On7:
        ...
        ThrowIfFailed(m_d3dDevice->CreateCommittedResource(
            ...
            nullptr,
            IID_PPV_ARGS(&m_d3dRenderTarget[0])
            ));
    }
    else
    {
    ...
    // Create frame resources.
    {
        ...
        for (UINT n = 0; n < FrameCount; n++)
        {
            ...
            else if (n > 0)
            {
                ...
                m_d3dRenderTarget[n] = m_d3dRenderTarget[0];
            }
...
void D3D12On7::PopulateCommandList()
{
    ...
    // re-recording.
    ThrowIfFailed(m_commandList->Reset(m_d3dCommandAllocator.Get(), m_pipelineState.Get()));
